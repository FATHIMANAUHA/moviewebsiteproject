...
class category(models.Model):
    ...
    def get_url(self):
        return reverse('movieapp:products_by_category', args=[self.slug, self.id])
...
class products(models.Model):
    ...
    slug=models.SlugField(max_length=250,unique=True)
    poster=models.ImageField(upload_to='poster1')
    ...
    def get_url(self):
        return reverse('movieapp:prodCatdetail',args=[self.category_id.slug,self.slug])
